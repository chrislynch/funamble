...
*/
 include '../../config.php';
 $ACCESS_PWD="$root_password"; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access
 ...
 'db'=>"$db_schema",  #optional, default DB
